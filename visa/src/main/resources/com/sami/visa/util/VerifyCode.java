...
//	@RequestMapping(value = "xuan/verifyCode", method = RequestMethod.GET)
	public String getVerifyCode(HttpServletRequest req, HttpServletResponse resp) throws ServletException, java.io.IOException {
		initxuan();
		// 定义图像buffer
		...
		for (int i = 0; i < codeCount; i++) {
			...
			g.drawString(strRand, (i==0?3:i * (x+3)), codeY);
			// 将产生的四个随机数组合在一起。
			randomCode.append(strRand);
		}
